  ...
  return (
    <>
     <div className="relative">
      <h2 className="col-span-9 text-5xl xl:text-[70px] font-serif italic mb-12 xl:mb-24 text-gray-800">A Sanctuary for Those in Darkness</h2>
       <div className='flex flex-col md:flex-row gap-8 xl:gap-24'>
         <p id="welcome" className="flex-1 text-gray-800 font-roboto text-xl xl:text-3xl/[1.5] lg:mt-10 leading-relaxed xl:font-light xl:max-w-[42rem]">
         ...
         <div id="granat" className="hidden flex-1 md:flex justify-end items-end">
           <img 
             src="/src/assets/images/pom_1.webp" 
