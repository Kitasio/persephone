        ...
        <div className="space-y-32 md:space-y-48">
          ...
          <div className="flex flex-col lg:flex-row-reverse lg:items-center lg:justify-between gap-8">
            <div className="lg:max-w-[60%]">
              ...
              <p className="text-neutral-900 font-roboto text-xl xl:text-3xl/[1.5] font-light text-left lg:text-right">
              ...
              <ul className="list-disc pl-6 lg:pl-0 lg:list-none space-y-4 mt-6 text-neutral-900 font-roboto text-xl xl:text-3xl/[1.5] font-light text-left lg:text-left">
                <li className="lg:before:content-['•'] lg:before:mr-4">Grief is a Natural Response to Loss</li>
                <li className="lg:before:content-['•'] lg:before:mr-4">Time Alone Does Not Heal Grief</li>
                <li className="lg:before:content-['•'] lg:before:mr-4">Unresolved Grief Comes from Unfinished Emotional Business</li>
                <li className="lg:before:content-['•'] lg:before:mr-4">Grief Needs to Be Expressed, Not Suppressed</li>
                <li className="lg:before:content-['•'] lg:before:mr-4">Recovery Doesn't Mean Forgetting</li>
              </ul>
            </div>
            <a 
