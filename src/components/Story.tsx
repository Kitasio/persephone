...
const Story: React.FC<StoryProps> = ({
  title = "The Story",
  content = "In ancient times, Persephone was the beloved daughter of Demeter, goddess of the harvest and life-giving earth. Persephone wandered through sunlit meadows, her laughter filling the air as she ran among wildflowers. Her presence was light itself, vibrant and joyful. Wherever she walked, flowers opened to the sun, trees burst into bloom, and the earth was rich with abundance.",
...
Let's see the promise of new life.`
}) => {
